    ...
    <section class="spad">
        <div class="container-fluid">
            <div class="row">
                ...
                <%-- ======================================================== --%>
                <%-- 1. SIDEBAR (MENU TRÁI) - Dùng Component chung            --%>
                <%-- ======================================================== --%>
                <div class="col-lg-3 col-md-4">
                    <%-- 
                        INCLUDE FILE SIDEBAR VỪA TẠO 
                        param activePage='checkin' để tô màu dòng đầu tiên
                    --%>
                    <jsp:include page="../components/sidebar-receptionist.jsp">
                        <jsp:param name="activePage" value="checkin"/>
                    </jsp:include>
                </div>

                <%-- ======================================================== --%>
                <%-- 2. MAIN CONTENT (NỘI DUNG)                               --%>
                <%-- ======================================================== --%>
