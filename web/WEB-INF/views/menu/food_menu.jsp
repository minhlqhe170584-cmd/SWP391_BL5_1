...
<head>
    ...
    <style>
        .menu-section { padding-top: 50px; padding-bottom: 80px; }
        .menu-item-inner { border-radius: 8px; transition: background-color 0.3s; }
        .menu-item-inner:hover { background-color: #f7f7f7; }
        .quantity-input { border-radius: 5px; border: 1px solid #ccc; }
        .service-image { width: 80px; height: 80px; object-fit: cover; border-radius: 5px; margin-right: 15px; }
    </style>
</head>
<body>
