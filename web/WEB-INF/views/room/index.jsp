...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/components-admin.css">
<!-- Start GA -->
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.jsp.html">Stisla</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.jsp.html">St</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class=active><a class="nav-link" href="index.jsp.html">Ecommerce Dashboard</a></li>
              </ul>
            </li>
...
<!-- Keep Stisla local (no CDN available) -->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/chocolat/0.4.21/js/jquery.chocolat.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath}/assets/js/page/index-admin.js"></script>
  
  <!-- Template JS File -->
  <script src="${pageContext.request.contextPath}/assets/js/scripts-admin.js"></script>
  <script src="${pageContext.request.contextPath}/assets/js/custom-admin.js"></script>
</body>
</html>